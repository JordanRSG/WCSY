...
define config.name = _("WE CAN SHOW YOU")
...
define gui.about = _p("""a simple test to see how it works 
...
define config.save_directory = "teste1-1534760974"
